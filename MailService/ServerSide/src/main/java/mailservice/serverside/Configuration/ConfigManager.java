...
public class ConfigManager {
    ...
    */
    ...
    private File getDir() {
        String uri = new File("").getAbsolutePath() + File.separator + "mailservice" + File.separator + "ServerSide" + File.separator + "src" + File.separator + "main" + File.separator + "Server.properties";
        return new File(uri);
    }
}
